  ...
  return (
    ...
    >
              ...
              <a href="https://www.instagram.com/rikalovic/" target="_blank">
                <button className="relative w-12 h-12 rounded-full group">
                  ...
                  <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-violet-400 rounded-full">
                    ...
                    >
                      <path
                        className="group-hover:fill-violet-400 fill-white duration-300"
              ...
              <a href="https://github.com/veljkorikalovic" target="_blank">
                <button className="relative w-12 h-12 rounded-full group">
                  ...
                  <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-gray-800 rounded-full">
                    ...
                    >
                      <path
                        className="group-hover:fill-gray-800 fill-white duration-300"
              ...
              >
                <button className="relative w-12 h-12 rounded-full group">
                  ...
                  <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
                    ...
                    >
                      <path
                        className="group-hover:fill-blue-500 fill-white duration-300"
      ...
      <div className="sm:w-2/4 w-full">
        <div className="max-w-md mx-auto relative overflow-hidden z-1 p-8">
